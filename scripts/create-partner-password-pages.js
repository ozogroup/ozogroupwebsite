...
const forgotDir = path.join(base, "app", "(admin)", "partner", "forgot-password");
const resetDir = path.join(base, "app", "(admin)", "partner", "reset-password");
...
console.log("Created forgot-password/page.tsx");
console.log("Created reset-password/page.tsx");