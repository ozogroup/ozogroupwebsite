...
export default function Sidebar({ open, onClose }: SidebarProps) {
  ...
  return (
    <>
      {/* Mobile sidebar */}
      <div
        className={`fixed inset-y-0 left-0 z-[9999] w-[260px] max-w-[86vw] bg-brand-ink transform transition-transform duration-300 ease-in-out lg:hidden ${
        ...
        <div className="flex min-h-0 flex-col h-full overflow-hidden">
          ...
          <div className="p-4 border-t border-brand-light/30">
            <div className="flex items-center gap-3 p-3 rounded-xl bg-white/10">
              <div className="w-10 h-10 bg-gradient-to-br from-brand-ink to-brand-muted rounded-full flex items-center justify-center">
        ...
        <div className="flex min-h-0 flex-col h-full overflow-hidden">
          ...
          <div className="p-3 border-t border-brand-light/30">
            <div className="flex items-center gap-3 p-2.5 rounded-lg hover:bg-white/10 transition-colors">
              <div className="w-9 h-9 bg-gradient-to-br from-brand-ink to-brand-muted rounded-full flex items-center justify-center">
