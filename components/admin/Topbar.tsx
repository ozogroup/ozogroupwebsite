      ...
      <div className="flex min-w-0 items-center justify-between gap-3 px-4 py-3.5 md:px-6 lg:px-8">
        ...
        <div className="flex min-w-0 items-center gap-3 md:gap-4">
          ...
          <div className="min-w-0">
            <h1 className="truncate text-[15px] font-semibold text-brand-ink">{title}</h1>
          </div>
        </div>
        ...
        <div className="flex shrink-0 items-center gap-2 md:gap-3">
          ...
          <div className="relative hidden md:block">
            <svg className="w-4 h-4 text-brand-muted absolute left-3 top-1/2 -translate-y-1/2 pointer-events-none" fill="none" stroke="currentColor" viewBox="0 0 24 24">
              <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M21 21l-6-6m2-5a7 7 0 11-14 0 7 7 0 0114 0z" />
            </svg>
            <input
              type="text"
              placeholder="Search admin..."
              className="w-64 pl-9 pr-3 py-1.5 text-sm bg-brand-surface border border-brand-border rounded-lg focus:outline-none focus:ring-2 focus:ring-brand-primary/40 focus:border-brand-primary focus:bg-brand-card transition-colors placeholder:text-brand-muted"
            />
          </div>
          ...
          <div className="relative">
            <button
              ...
              className="p-2 rounded-lg hover:bg-brand-light transition-colors text-brand-muted hover:text-brand-ink relative"
            >
          ...
          <a
            ...
            className="hidden sm:inline-flex items-center gap-2 px-3 py-2 text-sm text-brand-muted hover:text-brand-primaryDark transition-colors hover:bg-brand-surface rounded-lg"
          >
          ...
          <div className="relative">
            <button
              ...
              className="flex items-center gap-3 p-2 rounded-lg hover:bg-brand-light transition-colors"
            >
              ...
              <div className="hidden md:block text-left">
                ...
                <p className="text-xs text-brand-muted mt-0.5">KIA Skin Care</p>
              </div>
              <svg className="w-4 h-4 text-brand-muted hidden md:block" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M19 9l-7 7-7-7" />
              </svg>
            </button>
            {profileOpen && (
              <div className="absolute right-0 top-full mt-2 w-[calc(100vw-2rem)] max-w-56 bg-brand-card rounded-xl shadow-lg border border-brand-border py-2">
