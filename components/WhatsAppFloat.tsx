...
export default function WhatsAppFloat() {
  return (
    ...
    >
      ...
      <span className="relative flex h-14 w-14 items-center justify-center rounded-full bg-brand-primary text-white shadow-card transition duration-200 group-hover:scale-105 group-hover:bg-brand-primaryDark">
