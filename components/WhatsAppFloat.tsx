    ...
    >
      ...
      {contactSettings.instagram ? (
        <a
          ...
          className="fixed right-4 z-40 group bottom-[calc(max(1rem,env(safe-area-inset-bottom))+4rem)] sm:right-5 sm:bottom-[5.75rem]"
        >
          <span className="relative flex h-12 w-12 items-center justify-center rounded-full bg-gradient-to-tr from-[#feda75] via-[#d62976] to-[#4f5bd5] text-white shadow-card transition duration-200 group-hover:scale-105">
      ...
      {contactSettings.facebook ? (
        <a
          ...
          className="fixed right-4 z-40 group bottom-[calc(max(1rem,env(safe-area-inset-bottom))+7.5rem)] sm:right-5 sm:bottom-[10.25rem]"
        >
          <span className="relative flex h-12 w-12 items-center justify-center rounded-full bg-[#1877F2] text-white shadow-card transition duration-200 group-hover:scale-105">
            <svg width="22" height="22" viewBox="0 0 24 24" fill="currentColor">
