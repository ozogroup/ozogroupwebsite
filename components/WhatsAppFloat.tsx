...
const FACEBOOK_FALLBACK = "https://www.facebook.com/profile.php?id=61591206116153&mibextid=ZbWKwL";
const INSTAGRAM_FALLBACK = "https://www.instagram.com/kiaskincareindia?igsh=MTl2c2h4cnh0dHBjOQ==";

export default function WhatsAppFloat({ whatsappUrl }: { whatsappUrl: string }) {
  ...
  return (
    ...
    >
      ...
      <a
        ...
        className="group relative"
      >
        <span className="pointer-events-none absolute inset-0 rounded-full bg-[#25D366]/30 blur-lg animate-pulse" />
