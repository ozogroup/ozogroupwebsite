  ...
  return (
    <div className="space-y-6">
      <div>
        ...
        <p className="text-slate-600">Manage partner memberships</p>
      </div>
        ...
        <table className="w-full">
          <thead className="bg-slate-50 border-b border-slate-200">
            <tr>
              ...
              <th className="px-6 py-3 text-left text-xs font-medium text-slate-500 uppercase">Membership Status</th>
