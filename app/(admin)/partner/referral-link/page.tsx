      ...
      <div className="bg-gradient-to-r from-brand-accent to-brand-light rounded-xl shadow-lg p-8 text-white">
        ...
        <div className="flex flex-wrap gap-4">
          ...
          <a
            ...
            className="px-6 py-3 bg-brand-primary text-white rounded-lg font-medium hover:bg-brand-primaryDark transition-colors flex items-center gap-2"
          >
          ...
          <a
            ...
            target="_blank"
            rel="noopener noreferrer"
            className="px-6 py-3 bg-brand-primaryDark text-white rounded-lg font-medium hover:bg-brand-primary transition-colors flex items-center gap-2"
          >
            <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
