              ...
              <tr>
                <td colSpan={7} className="px-6 py-16 text-center">
                  <div className="flex flex-col items-center gap-3">
                    ...
                    <button
                      onClick={() => setShowModal(true)}
                      className="mt-2 px-4 py-2 bg-gradient-to-r from-brand-ink to-brand-muted text-white text-sm font-medium rounded-lg hover:shadow-glow transition-all"
                    >
                      Add Partner
                    </button>
                  </div>
            ...
            <form onSubmit={handleCreate} className="space-y-4">
              ...
              <div className="flex gap-3 pt-4">
                <button
                  type="submit"
                  disabled={saving}
                  className="flex-1 px-6 py-2.5 bg-gradient-to-r from-brand-ink to-brand-muted text-white text-sm font-medium rounded-lg hover:shadow-glow transition-all disabled:opacity-60"
                >
            ...
            <div className="p-6 space-y-6">
              ...
              <div>
                ...
                <a
                  ...
                  className="inline-flex items-center gap-2 px-4 py-2.5 bg-brand-ink text-white rounded-lg hover:bg-brand-muted transition-colors font-medium"
                >
