...
export default function PartnerLoginPage() {
  ...
  return (
    <main className="relative min-h-screen overflow-hidden bg-[#fbf8f2] px-4 py-8 text-brand-ink sm:px-6 lg:px-8">
      <div className="pointer-events-none absolute inset-0">
        <div className="absolute inset-0 bg-[radial-gradient(circle_at_18%_16%,rgba(27,163,198,0.14),transparent_32%),radial-gradient(circle_at_82%_8%,rgba(13,92,125,0.12),transparent_30%),linear-gradient(135deg,rgba(255,255,255,0.94),rgba(245,250,252,0.74))]" />
        <div className="absolute left-6 top-8 h-48 w-48 rounded-full border border-brand-primary/10" />
        <div className="absolute bottom-10 right-6 h-64 w-64 rounded-full border border-luxury-gold/20" />
        <div className="absolute inset-x-0 top-0 h-40 bg-[linear-gradient(90deg,transparent,rgba(255,255,255,0.72),transparent)]" />
      </div>
      ...
      <div className="relative mx-auto grid min-h-[calc(100vh-4rem)] w-full max-w-6xl items-center gap-8 lg:grid-cols-[1.05fr_0.95fr]">
        <section className="order-2 space-y-7 lg:order-1">
          ...
          <div className="relative max-w-md overflow-hidden rounded-3xl border border-amber-200/70 bg-gradient-to-br from-[#f9e8a6] via-[#d7ad3c] to-[#9b6a12] p-[1px] shadow-premium">
            <div className="relative overflow-hidden rounded-3xl bg-[linear-gradient(135deg,rgba(18,18,16,0.94),rgba(78,55,11,0.88))] p-6 text-white">
              ...
              <div className="mt-8 grid grid-cols-2 gap-3 text-sm">
                <div className="rounded-2xl bg-white/10 p-3 ring-1 ring-white/[0.15]">
                  <p className="text-amber-100/80">Referrals</p>
                  <p className="mt-1 font-semibold text-white">Multi-level</p>
                </div>
                <div className="rounded-2xl bg-white/10 p-3 ring-1 ring-white/[0.15]">
                  <p className="text-amber-100/80">Access</p>
        ...
        <section className="order-1 lg:order-2">
          <form
            ...
            className="mx-auto w-full max-w-md rounded-[2rem] border border-white/80 bg-white/[0.88] p-6 shadow-premium backdrop-blur-md sm:p-8"
          >
